...
| 0x00B0–B3 | Load switch / V / A / W | reads failed 0x02 (region boundary) |
| 0x00B4–B7 | USB switch / V / A / W | " |
| 0x00B8/B9 | Internal / external temperature | " |
| 0x00BA/BB | Fan switch / speed | " |
...
Total runtime (2, s) · cumulative generation (2, ×0.1 kWh) · total consumption (2) · full-charge count · over-discharge count · today's Wh / PV max V,A,W / batt max-min V / consumption Wh / load max A,W / USB Wh,max A,max W (0x0308–0x0313) · yesterday (0x0314) … daily blocks; statistical log: 12-register records, date at word 14, h:m:s at words 15–16.
